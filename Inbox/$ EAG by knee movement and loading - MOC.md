...
- 전위가 잘 나오는 범위 공간의 중심위치 측정
	- 실험 1-2 : 슬개골 하부, 전방부 지방층(Hoffa's fat pad) 전방부에 전극 8개를 위치 시켜서 측정
		- 슬개골 하부, 인대 중심, 인대 끝, 각 연골 접촉면과의 최단거리, 바깥쪽 ITB insertion 위
	- 실험 1-3 : 후방부 
	

실험3 - 
능동신전에서 관절각도변화와 근수축에 의한 부하가 가해진 연골의 전위는 수동신전에서 관절각도 변화와 그에 따른 연조직 긴장에의한 수동적인 부하만 있는 연골보다 더 큰 전위 변화를 일으킬 것이다.
