...
1) 최적의 센서 위치 찾기(연골 부하 및 연골과 전극의 상대적 거리/위치변화 고려)
	- 정적인 상태		
		- 실제 관절각도 변화에 따른 전위 변화는 SGP로 발생가능한 크기에 비해 매우 크다. 때문에, 관절의 각도를 유지하면서 부하만 주었을 때 측정되는 적은량의 전위변화가 SGP에 의한 EAG이다.
		- 전위의 크기가 큰 위치들
	...
	- 운동 중 상태
		- 운동 중에는 부하의 변화에 더하여, 표면 전극과 내부 연골 사이의 상대적인 위치(상대적 방향과 거리)가 지속적으로 변화
			...
			- 현재 y축의 mV 환산값과 비교
			- 상대적위치변화와 부하 이외에도 관절운동에 따른 변화를 설명할 만한 다른 생리적 변화에 대한 설명

1) 무릎관절 운동 중 각도 변화에 의해 유발되는 EAG값들의 통계적 차이가 있다
