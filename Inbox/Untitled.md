...
To the knowledge of the authors, it is the first study to report the A. In this study, the authors identified the A.
...
## 3.2 B versus A parameters
## 3.3 C versus A parameters
